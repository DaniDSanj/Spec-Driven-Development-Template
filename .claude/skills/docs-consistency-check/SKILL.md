...
| 3 | Los commits siguen Conventional Commits y referencian el ID de feature | `git log <base>..HEAD --no-merges`; convención en `git-update-repo`. Los commits de Dependabot (`chore(deps): …`, sin ID de feature) quedan fuera de este punto |
